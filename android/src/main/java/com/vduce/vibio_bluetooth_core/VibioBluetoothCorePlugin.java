package android.src.main.java.com.vduce.vibio_bluetooth_core;
...
public class VibioBluetoothCorePlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    switch (call.method) {
      ...
      case "fhAuthFirstStepParams":
        //Parameters for the first step of obtaining certification
        Map<String, String> firstStepParams = FlutterHelper.fhAuthFirstStepParams();
        result.success(firstStepParams);
        break;
      case "fhAuthSecondStepParams": {
        //Parameters for the second step of obtaining certification
        String params = call.argument("params");
        Map<String, String> secondStepParams = FlutterHelper.fhAuthSecondStepParams(params);
        result.success(secondStepParams);
        break;
      }
