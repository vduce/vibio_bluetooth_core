...
import com.vduce.vibio_bluetooth_core.sha.MsgDigest;
import com.vduce.vibio_bluetooth_core.sha.util.ArrayUtils;
import com.vduce.vibio_bluetooth_core.sha.util.BytesUtils;
import com.vduce.vibio_bluetooth_core.sha.util.ConvertUtils;


public abstract class MessageDigest extends MsgDigest
        implements BytesUtils, ArrayUtils,ConvertUtils {
    ...
    public MessageDigest(String algorithm, int digestLength, int blockSize) {
        super(algorithm);
